...
Na sliki~\ref{fig:cantilever-beam-convergence} je prikazana konvergenca numerične rešitve proti analitični.
Napako pomikov in napetosti merimo relativno v $L_\infty$ normi. Če s strešico označimo izračunane količine, brez strešice pa analitične, potem napako izračunamo kot
\begin{align*}
