...
metodo končnih elementov~\cite{uienkiewicz2000finite}. Toda že v preteklosti so te probleme
...
numerično reševanje. Zgoraj omenjeno brezmrežno metod bomo v razdelku~\ref{sec:numericna-metoda}
...
lukenj. Za konec smo rešili še primer primer, motiviran s strani mehanike utrujanja materialov in
...
\bibliographystyle{fmf-sl-alpha}
