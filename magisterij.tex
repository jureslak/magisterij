...
\begin{opomba}
  ...
  \eps_{kl}$
\end{opomba}
Toda, iz trditve~\ref{trd:sigma-symmetric} o simetričnosti $\ts$ sledi, da lahko
...
Rešimo problem~\eqref{eq:poisson-problem} numerično, z štirimi različnimi nabori baznih funkcij: monomi,
